...
def MSE_Loss(codes, label_1, label_2, a, bit_weights=None):
    ...
    if k > 0:
        ...
        pred_2 = pred_2 - tf.stop_gradient(tf.where(pred_2>FLAGS.GED_threshold,
                                                  pred_2 - FLAGS.GED_threshold,
                                                  tf.zeros_like(pred_2)))
